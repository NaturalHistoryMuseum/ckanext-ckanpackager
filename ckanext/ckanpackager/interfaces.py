...
class ICkanPackager(interfaces.Interface):
    ...
    def before_package_request(self, resource_id, package_id, packager_url, request_params):
        '''
        Allows modification of the packager url and request parameters right before the request is sent to the
        ...
        :param request_params: the request parameters that will be sent to the ckanpackager
        :return: a tuple of the url and the params
        '''
